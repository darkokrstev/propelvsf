...
```sh
grep -rl 'propelvsf' ./ | xargs sed -i '' 's/propelvsf/{YOUR INTEGRATION NAME}/g'
```
...
Want to contribute? Ping us on `propelvsf` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/propelvsf.git
    cd propelvsf
    ```
...
- [propelvsf integration Documentation](https://docs.vuestorefront.io/propelvsf)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `propelvsf` channel on [our Discord](discord.vuestorefront.io).
